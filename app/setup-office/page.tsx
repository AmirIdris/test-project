        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-lg p-8 border border-white/20">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    id="size"
                    required
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:border-[#f59e0b] transition-colors text-white appearance-none"
                  >
                    <option value="" className="bg-[#1a1a1a] text-white">Choose Your Company Size</option>
                    <option value="1-10" className="bg-[#1a1a1a] text-white">1-10 employees</option>
                    <option value="11-50" className="bg-[#1a1a1a] text-white">11-50 employees</option>
                    <option value="51-200" className="bg-[#1a1a1a] text-white">51-200 employees</option>
                    <option value="201-500" className="bg-[#1a1a1a] text-white">201-500 employees</option>
                    <option value="500+" className="bg-[#1a1a1a] text-white">500+ employees</option>
                  </select>
            ...
            <div className="mt-6 text-center">
              <span className="text-gray-400">Already have an office setup?</span>{' '}
